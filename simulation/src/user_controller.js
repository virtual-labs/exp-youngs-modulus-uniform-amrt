(function(){
    ...
    */
    function UserController( $mdSidenav, $mdBottomSheet, $log, $q,$scope,$element,Fullscreen,$mdToast, $animate) {
        ...
        /** Function to set the distance between weight hangers */
        $scope.distanceOfWeightHangers = function(){
            distanceOfWeightHangersFn($scope); /** Function defined in experiment.js file */
        }
