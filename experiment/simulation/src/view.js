...
var container, weight_container_left, weight_container_right;

var IMG_INDX, CENTER, right_click, left_click, medium_weight;

var gravity_g, material_value, ruler_breadth, ruler_thicknes;

var zoom_area, scale_zoom_area, total_right_click;

var expression_e, mass, blade_distance, weight_hangers_distance, needle_y_value;

var needle_last_y, right_rotation, left_rotation, zoom_rooler_initial_y, initial_breadth;

var lense_down_initial, lense_up_initial, needle_zoom_y, rotation, weight_initial_y, weight_final_y;
...
function directiveFunction(){
	return {
		...
		link: function(scope, element,attrs){
            ...
            container = new createjs.Container(); /** Creating a container */
            container.name = "container";
            stage.addChild(container); /** Append it in the stage */
            weight_container_left = new createjs.Container(); /** Creating the left side weight container */
            weight_container_left.name = "weight_container_left";
            weight_container_left.x = 265;
            weight_container_left.y = 118;
            stage.addChild(weight_container_left); /** Append it in the stage */
            weight_container_right = new createjs.Container(); /** Creating the right side weight container */
            weight_container_right.name = "weight_container_right";
            weight_container_right.x = 410;
            weight_container_right.y = 118;
            stage.addChild(weight_container_right); /** Append it in the stage */
            zoom_container = new createjs.Container(); /** Creating the zoom container */
			...
			function handleComplete() {				
                ...
                for ( i = 0; i <= 13; i++ ){
                    if ( images_array[i] == "stand_left" ) { /** Adding mercury solution behind the thermometer */
                        loadImages(images_array[1],"stand_left",263, 121, "", 0, container,1); /** Center point between knife edge is 272 and 1cm = 9px */
                    } else if ( images_array[i] == "stand_right" ) {
                        loadImages(images_array[2],"stand_right",353, 121, "", 0, container,1); /** Center of knife edge is 272 */
                ...
                for ( i = weight_final_y; i >= weight_initial_y; i = i - 4 ) {
                    loadImages(images_array[IMG_INDX], "weight_left_"+_weight, 0, i, "", 0, weight_container_left, 0);
                    loadImages(images_array[IMG_INDX], "weight_right_"+_weight, 0, i, "", 0, weight_container_right, 0);
                    _weight -= 50;
                }
                loadImages(images_array[14],"weight_hanger", 0, 0, "", 0, weight_container_left, 1);                
                loadImages(images_array[16],"needle_small", 340, 90, "", 0, container, 1);
                loadImages(images_array[14],"weight_hanger2", 0, 0, "", 0, weight_container_right, 1);
...
function initialisationOfControls(scope){
    ...
    scope.weight_hangers_distance = 20; /** Initial value of distance between weight hangers */
...
function initialisationOfVariables() {
   ...
   CENTER = 308; /** Center point of balde edges */
